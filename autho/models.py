...
class CustomUser(AbstractUser):
    ...
    groups = models.ManyToManyField(
        ...
        blank=True,
        related_name='custom_users'  # Changed related_name
    )
...
class LabUser(AbstractUser):
    ...
    groups = models.ManyToManyField(
        ...
        verbose_name=_('groups'),
        blank=True,
        related_name='lab_users'  # Changed related_name
    )
    ...
    def __str__(self):
        return self.lab_email
    
    class Meta:
        verbose_name = 'Lab User'  # Name for a single object
